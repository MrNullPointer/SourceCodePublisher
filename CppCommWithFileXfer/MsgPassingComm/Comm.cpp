...
namespace MsgPassingCommunication
{
	Context::Context()
	{
		saveFilePath = FileSystem::Path::getFullFileSpec("../../SaveFiles");
		sendFilePath = FileSystem::Path::getFullFileSpec("../../SendFiles"); 
	}
	Context ctx;
...
bool Sender::sendFile(Message msg)
{
   ...
   /* std::string fileSpec = ctx.sendFilePath + "/" + msg.value("sendingFile");
	...
	std::string fileSpec = msg.value("sendingFile");
	std::cout << FileSystem::Path::getFullFileSpec(fileSpec) << std::endl;
	std::cout << "===================================================" << std::endl;
...
public:
	...
	*/
	bool receiveFile(Message msg)
	{
		...
		std::string fileName =path.getName(msg.value("sendingFile"));
		std::string fileSpec = "../../../SaveFiles/" + fileName;
		fileSpec = FileSystem::Path::getFullFileSpec(fileSpec);
		std::cout << "=================================" << fileSpec << "\n";
